...
export default function Courses() {
  ...
  const courses = [
    ...
    },
    {
      ...
      price: { usd: "$279", egp: "4,500EGP" },
      originalPrice: { usd: "$379", egp: "6,100EGP" },
      rating: 4.6,
      students: 987,
      duration: "12 weeks",
      level: "Advanced",
    ...
    },
    {
      ...
      description:
        "Comprehensive English language course from beginner to advanced level with native speakers.",
    ...
    },
    {
      ...
      description:
        "Interactive Spanish conversation course focusing on practical communication skills.",
    ...
    {
      id: 9,
      title: "Medical Terminology & Procedures",
      description:
        "Essential medical terminology and procedures for healthcare professionals and students.",
      image: "bg-gradient-to-br from-green-500 to-emerald-600",
    ...
    {
      id: 10,
      title: "Nursing Care Fundamentals",
      description:
        "Comprehensive nursing care course covering patient care, safety, and medical procedures.",
    ...
    },
    {
      ...
      description:
        "Master advanced mathematical concepts including calculus, algebra, and mathematical reasoning.",
    ...
    },
    {
      ...
      description:
        "Develop logical reasoning and critical thinking skills for problem-solving and decision making.",
      image: "bg-gradient-to-br from-purple-500 to-indigo-600",
      price: { usd: "$179", egp: "2,900EGP" },
      originalPrice: { usd: "$249", egp: "4,000EGP" },
      rating: 4.7,
      students: 2089,
      duration: "10 weeks",
      level: "Beginner",
