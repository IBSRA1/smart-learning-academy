...
const translations = {
  ...
  ar: {
    ...
    "home.hero.slide1.title": "أكاديمية التعلم ا��ذكي",
    ...
    "courses.search": "الب��ث في الدورات...",
    ...
    "about.cta.subtitle":
      "انضم لمجتمع المتعل��ين وكن جزءاً من عائلة أكاديمية التعلم الذكي.",
    ...
    "success.saved": "تم حفظ التغييرات ب��جاح!",
